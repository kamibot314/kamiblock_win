...
public class SoundsPart extends UIPart {
	...
	public function SoundsPart(app:Main) {
		trace("SoundsPart In!!!!!!");
		this.app = app;
	...
	public static function strings():Array {
		new SoundsPart(Main.app).showNewSoundMenu(Menu.dummyButton());
		return [
	...
	public function selectSound(snd:ScratchSound):void{
		trace("SoundsPart selectSound() In!!!!!!!!!!!");
