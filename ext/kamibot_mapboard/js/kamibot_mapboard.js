...
(function(ext) {
	...
	"C8":4186,"D8":4699};
	var beats = {"Whole":1000,"Half":500,"Quater":250,"Eighth":125,"Zero":0};
	var IR = {
	...
	ext.runBlockMove = function(count){
        runPackage(100,count);
	};
	
	ext.runBlockTurnLeft = function(){
        runPackage(101);
	};
	
	ext.runBlockTurnRight = function(){
        runPackage(102);
	};
	
	ext.runBlockTurnBack = function(){
        runPackage(103);
	};
	...
	ext.runServo = function(angle){
		runPackage(33,pins["SERVO_MOTOR_PIN"],angle);
	};
